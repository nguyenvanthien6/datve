...
namespace GUI.DAO
{
    public class DataProvider
    {
        ...
        //private static string connectionSTR = "Data Source=Z\SQLEXPRESS;Initial Catalog=QLRP;Integrated Security=True";
        //private static string connectionSTR = "Data Source=DESKTOP-G3TR9OQ;Initial Catalog=QLRP;Integrated Security=True";
        private static string connectionSTR = Properties.Settings.Default.connectionSTR;//= "Data Source=Z\SQLEXPRESS;Initial Catalog=QuanLyRapTau;User ID=sa;pwd=thaithang1";
