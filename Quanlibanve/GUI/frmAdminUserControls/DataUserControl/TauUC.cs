...
{
    public partial class TauUC : UserControl
    {
        ...
        {
            string screenName = (string)dtgvCinema.SelectedCells[0].OwningRow.Cells["Loại phòng"].Value;
        ...
        {
            if (TauDAO.InsertCinema(id, name, idMH, seats, status, numberOfRows, seatsPerRow))
            {
